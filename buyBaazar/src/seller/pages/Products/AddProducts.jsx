        ...
        <Grid container spacing={2}>
          ...
          <Grid size={{xs:12,md:4,lg:3}}>
            <FormControl fullWidth error={formik.touched.sizes && Boolean(formik.errors.sizes)} required>
              ...
              <Select labelId='sizes-label' id='sizes' name='sizes' value={formik.values.sizes} onChange={formik.handleChange} label="Sizes">
              <MenuItem value=''>
                  <em>None</em>
                </MenuItem>
                {
          ...
          <Grid size={{xs:12,md:4,lg:4}}>
            <FormControl fullWidth error={formik.touched.category && Boolean(formik.errors.category)} required>
              ...
              <Select labelId='category2-label' id='category' name='category2' value={formik.values.category2}
              onChange={formik.handleChange} label='Category'>
                {/* {mainCatego.map((item)=>(
                  <MenuItem value={item.categoryId}>{item.name}</MenuItem>
                ))} */}
           ...
           <Grid size={{xs:12,md:4,lg:4}}>
            <FormControl fullWidth error={formik.touched.category && Boolean(formik.errors.category)} required>
              ...
              <Select labelId='category3-label' id='category' name='category2' value={formik.values.category3}
              onChange={formik.handleChange} label='Category'>
                {/* {mainCatego.map((item)=>(
                  <MenuItem value={item.categoryId}>{item.name}</MenuItem>
                ))} */}
          ...
          <Grid size={{xs:12}}>
            <Button sx={{p:"14px"}} color='primary' variant='contained' fullWidth type='submit'>
              {true?<CircularProgress size='small'/>:""}
            </Button>
          </Grid>
